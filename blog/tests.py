...
class BlogPostTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post1 = Post.objects.create(
            ...
            status=Post.STATUS_CHOICES[0][0],  # Published or #'pub'
            author=cls.user,
        )
        cls.post2 = Post.objects.create(
            title='Post2',
            text='This Is Some Explains About Post2',
    ...
    def test_post_detail(self):
        ...
        self.assertEquals(self.post1.text, 'This Is The Description Of Post1')
    ...
    def test_post_detail_url_by_name(self):
        response = self.client.get(reverse('post_detail', args=[self.post1.id]))  # ---> (f'/blog/{self.post1.id}/')
        self.assertEqual(response.status_code, 200)

    def test_post_details_on_blog_detail_page(self):
        response = self.client.get(f'/blog/{self.post1.id}/')  # ---> reverse('post_detail', args=[self.post1.id])
        self.assertContains(response, self.post1.title)
        self.assertContains(response, self.post1.text)

    def test_status_4o4_if_post_id_not_exist(self):
    ...
    def test_post_create_view(self):
        ...
        self.assertEqual(Post.objects.last().text, 'This is about text')
